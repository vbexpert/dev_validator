...
namespace WindowsApplication1
{
    ...
    public class cls_output_controller
    {
        ...
        public void _v_form(object obj)
        {
            ...
            {
                _add_v_result(0, false, obj.ToString());
            }
        }
        public void _v_parm(object obj, string s_obj_name, string s_controled_value)
        {
            ...
            {
                _add_v_result(0, false, s_obj_name + "=" + obj.ToString() + " master value: " + s_controled_value);
            }
        }
        ...
        public void _v_neg_parm(object obj, string s_obj_name, string s_controled_value)
        {
            ...
            {
                _add_v_result(0, false, s_obj_name + "=" + obj.ToString() + " master negative value: " + s_controled_value);
            }
        }
        ...
        {
            string s_php_tail = ";\r\n";
            string s_reply = "$_SESSION['vrp_count'] = " + ilst_validated_parms.Count.ToString() + s_php_tail;
            int i_ctr = 0;
            foreach (cls_VResult vr in ilst_validated_parms)
            {
                ...
                s_reply += "$_SESSION['vr" + i_ctr.ToString() + "_reslt'] = " + vr.b_result.ToString() + s_php_tail;
                s_reply += "$_SESSION['vr" + i_ctr.ToString() + "_error'] = \"" + vr.s_error_details.ToString() + "\"" + s_php_tail;
                s_reply += "$_SESSION['vr" + i_ctr.ToString() + "_score'] = " + vr.i_score_points.ToString() + s_php_tail;
                i_ctr++;
            }
            return s_reply;
        }
