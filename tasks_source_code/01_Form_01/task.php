...
$cls_Task->_add_step("<a class='btn btn-danger regular_button' href='https://youtu.be/3eJduWO4EtQ' role='button' target='_blank'>Подивитись відеоурок</a>");
...
$cls_Task->_add_step("<a class='btn btn-danger regular_button' href='https://youtu.be/VGgci4rdczI' role='button' target='_blank'>Подивитись відеоурок</a>");
