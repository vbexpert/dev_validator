...
$cls_Task->_add_property("btn_Close.Height", "Висота кнопки", "200");
$cls_Task->_add_property("btn_Close.Location.X", "Ордината кнопки", "100");
$cls_Task->_add_property("btn_Close.Location.Y", "Абсциса кнопки", "150");
