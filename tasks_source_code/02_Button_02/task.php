...
$cls_Task->s_description = "Розміщення кнопки";
...
$cls_Task->_add_property("Form.Text", "Текст Форми", "Розміщення кнопки");
...
$cls_Task->_add_property("button1.Text", "Текст кнопки", "Close");
