...
<html>
  <head>
    <!-- title -->
    <title>Завдання controls 5.3.1:</title>
	<!-- utf8 support: -->
     ...
     <div class="starter-template">
	  <!-- header info block start: -------------------------------------------------------------------------------->
       ...
       <div class="jumbotron">
         ...
         <hr>
		 <h1 class="">Завдання TextBox_01</h1>
         ...
         <table style="width:100%" class="table table-striped table-condensed">
			  <caption style="caption-side: top">Форма Form</caption>
			<thead>
			  <tr>
				<th>Properties</th>
				<th>Властивість</th>
		...
		<table style="width:100%" class="table table-striped table-condensed">
			  <caption style="caption-side: top">Текстове поле TextBox</caption>
			<thead>
			  <tr>
				<th>Properties</th>
				<th>Властивість</th>
			...
			<tr>
				<td>Width</td>
				<td>Ширина</td>
				<td><b>300</b>  пікселів</td>
				<td><input type="checkbox" value=""></td>
			  </tr>
			<tr>
				<td>Location.X</td>
				<td>Розміщення</td>
				<td><b>100</b>  пікселів</td>
				<td><input type="checkbox" value=""></td>
			  </tr>
			  <tr>
				<td>Location.Y</td>
		...
		<!-- help block end ----------------------------------------------------------------------------------->
         ...
         <h2 class=''>Перевірка:</h2>
           ...
           <form action="..\..\validator_fe.php" method="post" enctype="multipart/form-data">
			 ...
			 <!-- uploader end -->
			 <input type="hidden" name="codefile" value="04_TextBox_01"> <!-- task id -->
         </form>
