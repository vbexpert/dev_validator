     ...
     <div class="starter-template">
	  <!-- header info block start: -------------------------------------------------------------------------------->
       ...
       <div class="jumbotron">
         ...
         <hr>
		 <h1 class="">Завдання Form_05</h1>
         <h3 class="">Самостійне встановлення деяких властивостей</h3>
		...
		<caption style="caption-side: top">Form</caption>
		  ...
		  <tr>
		   <td>Text</td>
		   <td>Напис</td>
		   <td><b>Вікно на весь екран</b></td>
		   <td><input type="checkbox" value=""></td>
		  </tr>
		  <tr>
		   <td>MaximizeBox</td>
		   <td>Кнопка Розгорнути</td>
		   <td><b>Відключена</b></td>
		   <td><input type="checkbox" value=""></td>
		  </tr>
		  <tr>
		   <td>MinimizeBox</td>
		   <td>Кнопка Згорнути</td>
		   <td><b>Відключена</b></td>
		   <td><input type="checkbox" value=""></td>
		  </tr>
		  <tr>
		   <td>*</td>
		   <td></td>
		   <td><b>Запустити вікно Розгорнуте на весь екран</b></td>
		   <td><input type="checkbox" value=""></td>
		  </tr>
		</table>

         <div class="row pic-centered" >
           <img src="target_form.png" alt="..." width="100%">
         </div>
		...
		<!-- help block end ----------------------------------------------------------------------------------->
         ...
         <h2 class=''>Перевірка:</h2>
           ...
           <form action="..\..\validator_fe.php" method="post" enctype="multipart/form-data">
			 ...
			 <!-- uploader end -->
			 <input type="hidden" name="codefile" value="01_Form_05"> <!-- task id -->
         </form>
