...
$cls_Task->_add_step("<strike>2. Завантажити програму у <b>DEV-VALIDATOR</b>.</strike>");
$cls_Task->_add_step("<strike>3. Добитися повної валідації програми.</strike>");
$cls_Task->_add_step("<strike>4. Зберегти скріншот [Alt+PrintScreen] результатів у папку <b>Production</b>.</strike>");
...
$cls_Task->_add_object_creator("Додати об'єкт: ", "PictureBox");
