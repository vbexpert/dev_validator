...
<html>
 ...
 <body>
   <div class="container">
     ...
     <div class="row pic-centered task_desc_row">
           <a href="/validator/tasks/02_Button_05/task.php">Завдання 5: Робота з текстом - Відображення введеного тексту </a>
         </div>
     <div class="row pic-centered task_desc_row">
           <a href="/validator/tasks/02_Button_06/task.php">Завдання 6: Робота з 2 полями для вводу</a>
         </div>
         <div class="row pic-centered task_desc_row">
           <a href="/validator/tasks/02_Button_07/task.php">Завдання 7: Подвоєння введеного числа</a>
         </div>
     <div class="row pic-centered task_desc_row">
         ...
         <div class="row pic-centered task_desc_row">
           <a href="/validator/tasks/02_Button_11/task.php">Завдання 11: Квадрат </a>
         </div>
